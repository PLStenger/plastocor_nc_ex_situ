...
WORKING_DIRECTORY=/home/fungi/plastocor_nc_ex_situ/01_raw_data/Original_reads
OUTPUT=/home/fungi/plastocor_nc_ex_situ/03_cleaned_data

# Make the directory (mkdir) only if not existe already(-p)
mkdir -p $OUTPUT

ADAPTERFILE=/home/fungi/plastocor_nc_ex_situ/99_softwares/adapters_sequences.fasta
