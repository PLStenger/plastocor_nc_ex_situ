...
# Note: max-depth should be chosen based on ConTable.qzv (or on /home/fungi/plastocor_nc_ex_situ/05_QIIME2/export/visual/ConTable/sample-frequency-detail.csv)
